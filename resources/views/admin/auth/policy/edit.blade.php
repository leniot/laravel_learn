                        ...
                        <div class="box-body">
                            <div class="fields-group">
                                <div class="form-group {{ $errors->has('identifier') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="identifier" value="{{ $policy->identifier }}"
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" value="{{ $policy->name }}"
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" name="permissions[]" multiple>
                                            @foreach ($permissionList as $permission)
                                                <option @foreach($policy->permissions as $p_permission)
                                                            @if($permission->id == $p_permission->id)
                                                            {{ 'selected' }}
                                                            @endif
                                                        @endforeach
                                                        value="{{ $permission->id }}">
                                ...
                                <div class="form-group {{ $errors->has('desc') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{ $policy->desc }}"
