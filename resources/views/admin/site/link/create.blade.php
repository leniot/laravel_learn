                        ...
                        <div class="box-body">
                            ...
                            <div class="fields-group">
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="链接名称...">
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('site_address') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="site_address" name="site_address" value="{{ old('site_address') }}" placeholder="链接地址（带http或https）...">
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <label class="margin-r-5">
                                            <input type="radio" name="status" class="minimal-red" value="0"> 禁 用
                                        </label>
                                    </div>
