        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-widget">
                    ...
                    <form class="form-horizontal" pjax-container action="{{ admin_base_path('site/linkCategories') }}" method="post">
                        @csrf
                        <div class="box-body">
                            <div class="fields-group">

                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label for="name" class="col-sm-3 control-label">分 类 名 称：</label>

                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" value="{{ old('name') }}"
                                               name="name" placeholder="输入分类名称">
                                    </div>
                                    @if ($errors->has('name'))
