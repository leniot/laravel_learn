        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-widget">
                    ...
                    <form class="form-horizontal" pjax-container action="{{ admin_base_path('blog/categories') }}" method="post">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="fields-group">
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="类 别 名 称">
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('keywords') ? ' has-error' : '' }}">
                                    <label for="keywords" class="col-sm-3 control-label">类 别 名 称：</label>
